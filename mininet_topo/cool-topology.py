...
class GeneratedTopo( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        #info('*** Add links\n')
        # list_of_hosts = []
        # num_of_required_hosts = 6  # This number must be the same of num_of_required_hosts in topology_management.py
        ...
        info('*** Add links\n')
        self.addLink(s1_host, sA, bw=1000, delay='0.0ms')
        self.addLink(s2_host, sA, bw=1000, delay='0.0ms')
        self.addLink(s3_host, sA, bw=1000, delay='0.0ms')

        self.addLink(s4_host, sC, bw=1000, delay='0.0ms')
        self.addLink(s5_host, sC, bw=1000, delay='0.0ms')
        self.addLink(s6_host, sC, bw=1000, delay='0.0ms')
